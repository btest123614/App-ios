...
#import "RecipeMasterViewController.h"

#import "RecipeDetailViewController.h"

#import "Recipe.h"

@interface RecipeMasterViewController () {
    NSMutableArray *objects;
    NSArray *thisRecipe;
}
@end

@implementation RecipeMasterViewController
...
- (void)viewDidLoad
{
    ...
    thisRecipe = [[NSArray alloc] initWithObjects:recipe1, recipe2, recipe3, recipe4, recipe5, recipe6, recipe7, recipe8, recipe9, recipe10, recipe11, recipe12, recipe13, recipe14, recipe15, recipe16, nil];
    objects = [[NSMutableArray alloc] initWithArray:thisRecipe];
    //[objects addObjectsFromArray:thisRecipe];
    NSLog(@"%@",objects);
   // Recipe *recipes = [NSArray arrayWithObjects:recipe1, recipe2, recipe3, recipe4, recipe5, recipe6, recipe7, recipe8, recipe9, recipe10, recipe11, recipe12, recipe13, recipe14, recipe15, recipe16, nil];}
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    Recipe *temp = objects[indexPath.row];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    if ([segue.identifier isEqualToString:@"showDetail"]) {
        ...
        destViewController.recipe = [thisRecipe objectAtIndex:indexPath.row];
    }
}
